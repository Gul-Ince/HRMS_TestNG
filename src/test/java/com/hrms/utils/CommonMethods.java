...
public class CommonMethods extends PageInitializer {
	...
	// my method
	public static void FindChecbok(List<WebElement> radioOrcheckbox, String value) {
	...
	public static void sendText(WebElement employeeID, int empId) {
		employeeID.clear();
		employeeID.sendKeys();
	...
	public static String takeScreenshot(String filename) {
		...
		try {
			FileUtils.copyFile(file, new File(destinationFile));// add it to my reports
		} catch (Exception ex) {
